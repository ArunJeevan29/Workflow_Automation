...
export default function AdminApprovals() {
  ...
  const isOverdue = (item) => {
    const submittedTime = new Date(item.started_at || item.createdAt || Date.now());
    ...
    <div className="space-y-6 animate-in fade-in duration-500 pb-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Workflows waiting for your executive approval decision.</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          ...
          <input 
            ...
            className="pl-9 pr-4 py-2 border border-gray-200 text-sm w-64 focus:outline-none focus:ring-1 focus:ring-[#58bfa1] focus:border-[#58bfa1] rounded-lg shadow-sm" 
          />
        </div>
        ...
        <div className="relative">
          <button 
            ...
            className="flex items-center gap-2 px-4 py-2 border border-gray-200 text-gray-700 bg-white text-sm font-medium hover:bg-gray-50 transition-colors rounded-lg shadow-sm"
          >
          ...
          {isFilterOpen && (
            <div className="absolute left-0 mt-2 w-40 bg-white border border-gray-200 shadow-lg z-50 py-1 rounded-lg">
              ...
              <div className="p-5">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      {Object.keys(task.data).length > 4 && (
                        <div className="col-span-2 mt-1">
                          <span className="text-xs text-gray-400 font-medium">+{Object.keys(task.data).length - 4} more fields</span>
                        </div>
                      )}
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between text-xs text-gray-500 mb-4 px-1">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span>{new Date(task.started_at || Date.now()).toLocaleString()}</span>
                  </div>
                ...
                <div className="flex gap-3">
                  <Button 
                    ...
                    className="flex-1 justify-center bg-green-600 hover:bg-green-700 border-green-600 py-2.5"
                  >
